...
export class NotificationTemplateAdapter extends NotificationTemplateRepository {
  ...
  async createTemplate(
    ...
    logger.verbose(
      `NotificationTemplateAdapter called createTemplate method with param - ${JSON.stringify(data)}`,
    );
  ...
  async getTemplate(id: string): Promise<ResNotificationTemplateDto> {
    logger.verbose(
      `NotificationTemplateAdapter called getTemplate method with param - ${JSON.stringify(id)}`,
    );
  ...
  async getTemplates(
    ...
    if (type) {
      logger.verbose(
        `NotificationTemplateAdapter called getTemplates method with param - ${JSON.stringify(type)}`,
      );
    } else {
      logger.verbose(
        "NotificationTemplateAdapter called getTemplates without params",
      );
    }
  ...
  async updateTemplate(
    ...
    logger.verbose(
      `NotificationTemplateAdapter called updateTemplate method with params - ${JSON.stringify(id)}, ${JSON.stringify(data)}`,
    );
  ...
  async deleteTemplate(id: string): Promise<void> {
    logger.verbose(
      `NotificationTemplateAdapter called deleteTemplate method with param - ${JSON.stringify(id)}`,
    );

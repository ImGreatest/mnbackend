...
export class DadataController {
	...
	@ApiOperation({ summary: 'Do request to dadata api for get suggestions address' })
	@ApiBody({
	...
	async suggestsAddress(@Body() query: ReqSuggestsAddressDto): Promise<ResSuggestsAddressDto> {
	...
	@ApiOperation({ summary: "Do request to dadata api for standardization email" })
	@ApiBody({
	...
	async standardizationEmail(@Body() query: ReqStandardizationEmailDto): Promise<[]> {
	...
	async suggestsEmail(@Body() query: ReqSuggestsEmailDto): Promise<ResSuggestsEmailDto> {
		return this.dadataService.suggestsEmail(query);
	}

	@Post('standardization-phone')
	@ApiOperation({ summary: "Do request to dadata api for standardization phone" })
	@ApiBody({
	...
	async standardizationPhone(@Body() query: ReqStandardizationPhoneDto): Promise<[]> {

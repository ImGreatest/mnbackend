...
} from "../../../libs/domain/notification/dto/req-dto/req-create-notification-template.dto";
import {
	ResNotificationTemplateDto
} from "../../../libs/domain/notification/dto/res-dto/res-notification-template.dto";
import { ENotificationType, ERole } from "@prisma/client";
import {
	ResNotificationTemplatesDto
} from "../../../libs/domain/notification/dto/res-dto/res-notification-templates.dto";
import {
	ReqUpdateNotificationTemplateDto
} from "../../../libs/domain/notification/dto/req-dto/req-update-notification-template.dto";
import {
	ResUpdateNotificationTemplateDto
} from "../../../libs/domain/notification/dto/res-dto/res-update-notification-template.dto";
...
export class NotificationTemplateController {
	...
	createTemplate(@Body() data: ReqCreateNotificationTemplateDto): Promise<ResNotificationTemplateDto> {
	...
	getTemplates(@Query() type?: ENotificationType): Promise<ResNotificationTemplatesDto> {
